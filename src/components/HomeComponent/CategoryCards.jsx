...
const CategoryCards = () => {
    ...
    return (
        ...
        <div id="categories" className="py-16 px-6 md:px-16 mx-auto max-w-[1350px]">
            ...
            <h2 className="text-2xl md:text-4xl font-light text-center mb-14 text-gray-800 dark:text-white">
                Explore Our <span className="font-semibold bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400 bg-clip-text text-transparent">Categories</span>
            </h2>
